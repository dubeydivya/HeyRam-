...
function Homepage() {
    ...
    return <>
            <motion.div className='container-fluid home' initial={{width:0}} animate={{width:"100%"}} exit={{x:window.innerWidth,transition:{duration:0.1}}}>
                ...
                <div className='row text-center digital-row p-4 '>
                    <div className='col-md-12 d-flex justify-content-center'>
                        <div className='card-dig'>
                            ...
                            <Zoom><Link to='/digital-service'><button className='btn bg-dark dark text-white w-50 mt-5 p-3  ' >DISCOVER NOW</button></Link></Zoom>
                        </div>
                    </div>
                </div>
